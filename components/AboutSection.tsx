...
export default function AboutSection({ onBookingClick }: AboutSectionProps) {
  const practitioners = [
    {
      name: 'Michelle',
      title: 'Your Expert at Skulpt',
      image: '/images/clinic/hero-image.jpeg',
      bio: "At Skulpt Body Contouring, Michelle brings years of experience helping clients achieve their body goals. Whether you've lost weight through GLP-1 medications like Ozempic and Wegovy, or traditional methods, she specialises in tightening loose skin and contouring your body using advanced medical-grade technology. Based in Peterborough, Michelle is passionate about helping you feel confident in your transformed body with treatments that deliver real results.",
      qualifications: [
    ...
    <section id="about" className="py-12 sm:py-16 md:py-24 bg-white">
      <div className="max-w-7xl mx-auto section-padding">
        <div className="text-center mb-6 sm:mb-8 lg:mb-10">
          <span className="text-primary-600 font-medium tracking-wider uppercase text-xs sm:text-sm">Meet Your Expert</span>
          ...
          {practitioners.map((practitioner, index) => (
            <div key={index} className="bg-gradient-to-br from-white to-primary-50/30 rounded-2xl sm:rounded-3xl p-6 sm:p-8 shadow-premium hover:shadow-premium-lg transition-all duration-300">
              ...
              <div className="relative rounded-xl sm:rounded-2xl overflow-hidden shadow-lg mb-6">
                <div className="aspect-[4/3.6] relative">
                  <img
